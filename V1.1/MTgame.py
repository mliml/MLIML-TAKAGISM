...
def update_bag(equip_no,equip_count):
    ...
    print "你得到了%s，目前数量为%d" % (BAG[equip_no][0], equip_count)
    return BAG[equip_no][0]
...
def st001():
    ...
    elif op_global_data(2,0,None) >= 1:
        choice = player_input("你想要做什么：\n1.尝试去开门\n2.什么也不做")
